...
import $ from 'jquery'
import { each, map, orderBy, uniq, filter, values, some, toString, indexOf } from 'lodash'
...
export default React.createBackboneClass({
    ...
    renderHeader: function (field, displayName) {
        ...
        if (dataSource) {
            ...
            filterMenu = (
                <div id={'report-filter-ddl-' + field} className="dropdown-pane bottom" style={{ width: 'auto' }} data-dropdown data-close-on-click="true" data-auto-focus="false">
        ...
        return (
            <div>
                <a data-toggle={'report-filter-ddl-' + field}>{displayName}</a>
                {sortIcon}
                {filterIcon}
                {filterMenu}
            </div>
                ...
                <div className="small-12 columns">
                    ...
                    <div className="scroll-list-section-body">
                        <div className="row scroll-list-header">
                            ...
                            <div className="small-10 medium-5 columns">{this.renderHeader('ClientCode', 'Client Code')}</div>
                        ...
                        {list.map(function (item) {
                            return <ReportRow key={item.get('Id')} model={item} scrollToTaskId={scrollToTaskId} />
                        })}
                    </div>
                </div>
            </div>
