            ...
            <form onSubmit={this.onSave}>
                ...
                <div className="row">
                    ...
                    <fieldset className="small-12 columns">
                        ...
                        <input type="radio" onChange={this.onChange} name="AreaDescription" checked={'APT + HOME' == AreaDescription} value="APT + HOME" id="apthome" />
                        <label htmlFor="apthome">APT + HOME</label>
                        <input type="radio" onChange={this.onChange} name="AreaDescription" checked={'APT ONLY' == AreaDescription} value="APT ONLY" id="aptonly" />
                        <label htmlFor="aptonly">APT ONLY</label>
                        <input type="radio" onChange={this.onChange} name="AreaDescription" checked={'HOME ONLY' == AreaDescription} value="HOME ONLY" id="homeonly" />
                        <label htmlFor="homeonly">HOME ONLY</label>
                    </fieldset>
