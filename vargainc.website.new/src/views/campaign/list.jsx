...
import { map, orderBy, uniq, filter, values, some, toString, indexOf } from 'lodash'
import $ from 'jquery'
...
export default React.createBackboneClass({
    ...
    renderHeader: function (field, displayName) {
        ...
        return (
            <div>
                <a data-toggle={'campaign-filter-ddl-' + field}>{displayName}</a>
                {sortIcon}
                {filterIcon}
                {filterMenu}
            </div>
                ...
                <div className="small-12 columns">
                    ...
                    <div className="scroll-list-section-body">
                        ...
                        {list.map(function (item) {
                            return <CampaignRow key={item.get('Id')} model={item} />
                        })}
                    </div>
                </div>
            </div>
