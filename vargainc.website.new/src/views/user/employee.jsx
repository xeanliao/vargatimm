            ...
            <form onSubmit={this.onSave}>
                ...
                <div className="row">
                    ...
                    <fieldset className="small-12 columns">
                        <label>Role</label>
                        <input type="radio" onChange={this.onChange} name="Role" value="Walker" id="walker" />
                        <label htmlFor="walker">Walker</label>
                        <input type="radio" onChange={this.onChange} name="Role" value="Driver" id="driver" />
                        <label htmlFor="driver">Driver</label>
                        <input type="radio" onChange={this.onChange} name="Role" value="Auditor" id="autitor" />
                        <label htmlFor="autitor">Auditor</label>
                    </fieldset>
                    <div className="small-12 columns">
                        <label>
                            Cell Phone
