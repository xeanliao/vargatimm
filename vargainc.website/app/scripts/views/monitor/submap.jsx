...
export default React.createBackboneClass({
	...
	loadGtu: function () {
		...
		$.getJSON(address + '/print/campaign/' + campaignId).then(campaign => {
			...
			return $.getJSON(address + '/print/campaign/' + campaignId + '/submap/' + submapId + '/boundary')
				.then(result => {
			...
			return Promise.each(maps, i => {
				return $.getJSON(address + '/print/campaign/' + campaignId + '/submap/' + i.s + '/dmap/' + i.d + '/boundary')
					.then(result => {
						let latlngs = map(result.boundary, i => {
							return [i.lat, i.lng];
						});
			...
			return Promise.each(maps, i => {
				return $.getJSON(address + '/print/campaign/' + campaignId + '/submap/' + i.s + '/dmap/' + i.d + '/gtu')
					.then(result => {
