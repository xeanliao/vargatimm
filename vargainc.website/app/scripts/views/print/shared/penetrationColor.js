define(['moment', 'backbone', 'react', 'views/base', 'react.backbone', 'jquery-ui'], function (moment, Backbone, React, BaseView) {
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement('div', { className: 'slider', ref: 'colorSlider' })
						)
					),
					React.createElement(
						'div',
