define(['backbone', 'react', 'views/print/shared/options', 'views/print/shared/penetrationColor', 'views/print/shared/optionsDMapSelector', 'react.backbone'], function (Backbone, React, OptionsView, PenetrationColorView, OptionsDMapSelectorView) {
	return React.createBackboneClass({
		...
		render: function () {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'div',
							{ className: 'column' },
							React.createElement('input', { id: 'suppressGTU', name: 'suppressGTU', type: 'checkbox', checked: model.get('suppressGTU'), onChange: this.OnValueChanged }),
							React.createElement(
								'label',
								{ htmlFor: 'suppressGTU' },
				...
				React.createElement(OptionsDMapSelectorView, { collection: model.get('DMaps') }),
				React.createElement(
					'div',
					{ className: 'small-12 columns' },
					React.createElement(
