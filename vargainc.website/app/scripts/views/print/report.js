define(['jquery', 'underscore', 'moment', 'backbone', 'react', 'views/base', 'models/print/options', 'views/print/shared/reportOptions', 'views/print/shared/cover', 'views/print/shared/campaign', 'views/print/shared/campaignSummary', 'views/print/shared/submap', 'views/print/shared/submapDetail', 'views/print/shared/dmap', 'views/print/shared/dmapDetailMap', 'react.backbone'], function ($, _, moment, Backbone, React, BaseView, OptionsModel, OptionsView, CoverView, CampaignView, CampaignSummaryView, SubMapView, SubMapDetailView, DMapView, DMapDetailMapView) {
					...
					pages.map(function (page) {
						switch (page.get('type')) {
							...
							case 'SubMapDetail':
								...
								break;
							case 'DMap':
								return options.suppressDMap || _.indexOf(hideDMaps, page.get('DMapId')) > -1 ? null : React.createElement(DMapView, { ref: page.get('key'), key: page.get('key'), model: page, options: options });
								break;
							case 'DMapDetailMap':
								return options.suppressDMap || _.indexOf(hideDMaps, page.get('DMapId')) > -1 ? null : React.createElement(DMapDetailMapView, { ref: page.get('key'), key: page.get('key'), model: page, options: options });
								break;
							default:
								return null;
								break;
