define(['jquery', 'underscore', 'sprintf', 'moment', 'react', 'collections/user', 'models/user', 'views/base', 'views/mapBase', 'views/gtu/assign', 'views/user/employee', 'fastMarker', 'react.backbone'], function ($, _, helper, moment, React, UserCollection, UserModel, BaseView, MapBaseView, AssignView, EmployeeView, FastMarker) {
