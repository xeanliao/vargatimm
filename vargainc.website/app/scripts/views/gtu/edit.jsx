...
import { each, groupBy, indexOf, remove, filter, last, map, isEmpty, uniqueId, first, dropRight } from 'lodash'
import $ from 'jquery'
...
export default React.createBackboneClass({
    ...
    render: function () {
        ...
        if (!canUndoSave) {
            var undoButton = (
                <button className="button float-right" disabled onClick={this.onUnderGtu}>
                    <i className="fa fa-undo"></i>Undo
                </button>
            )
            var saveButton = (
                <button className="button float-right" disabled onClick={this.onSaveGtu}>
                    <i className="fa fa-save"></i>Save
                </button>
            )
        } else {
            var undoButton = (
                <button className="button float-right" onClick={this.onUnderGtu}>
                    <i className="fa fa-undo"></i>Undo
                </button>
            )
            var saveButton = (
                <button className="button float-right" onClick={this.onSaveGtu}>
                    <i className="fa fa-save"></i>Save
                </button>
            )
        }
                ...
                <div className="section row">
                                ...
                                <div className="small-12 column">
                                    <nav aria-label="You are here:" role="navigation">
                                        <ul className="breadcrumbs">
                                            ...
                                            <li>
                                                <a href={'#report/' + this.props.task.get('Id')}>Report</a>
                                            </li>
                                            <li>
                    ...
                    <div className="small-12 medium-5 large-3 columns">
                        ...
                        <button className="button float-right" onClick={this.onReCenter}>
                            <i className="fa fa-refresh"></i>ReCenter
                        </button>
                    </div>
                </div>
