...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        bower: {
            style: {
                ...
                options: {
                    ...
                    expand: false,
                    ignorePackages: ['bootstrap', 'jquery', 'tether', 'SVG-Loaders'],
                    packageSpecific: {
                        'font-awesome': {
        ...
        sass: {
            options: {
                implementation: sass,
                outputStyle: 'compact', // expanded or nested or compact or compressed
                sourceMap: false,
                includePaths: [
                    'bower_components',
                    'node_modules',
        ...
        webpack: {
            options: {
                ...
                module: {
                    ...
                    noParse: [/localforage\/dist\/localforage.js/, /mapbox-gl/],
                },
                hot: false,
            },
            dist: {
                ...
                files: [
                    {
                        ...
                        cwd: '<%= app %>',
                        dest: '<%= dist %>',
                        src: ['*.{ico,png,txt}', 'images/{,*/}*.webp', 'release.html', 'fonts/{,*/}*.*'],
                    },
                ],
            },
            vendor: {
        ...
        usemin: {
            options: {
                assetsDirs: ['<%= dist %>', '<%= dist %>/images', '<%= dist %>/css'],
            },
            html: ['<%= dist %>/{,*/}*.html'],
            css: ['<%= dist %>/css/{,*/}*.css'],
        },
        ...
        concurrent: {
            dist: ['webpack', 'sass', 'imagemin', 'svgmin'],
        },
        compress: {
            options: {
                archive: function () {
        ...
        'webpack-dev-server': {
            options: {
                proxy: {
                    //http://timm.vargainc.com/dev/api/user/login?username=admin&password=newpass
                    '/api/**': {
                        target: '//timm.vargainc.com/',
                ...
                webpack: {
                    cache: true,
                    entry: {
                        app: ['./app/scripts/main', 'webpack/hot/only-dev-server'],
                    ...
                    resolve: {
                        ...
                        extensions: ['', '.js', '.jsx'],
                        modulesDirectories: ['app/scripts', 'node_modules/foundation-datepicker/js', 'bower_components', 'node_modules'],
                    },
                    module: {
                        loaders: [
                            {
