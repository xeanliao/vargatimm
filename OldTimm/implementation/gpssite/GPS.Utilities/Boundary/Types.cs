    ...
    public class Types
    {
        ...
        public class Line
        {
            ...
            public void setSlop(Decimal slop)
            {
                ...
                this.slop = Math.Round(slop, SCALE, MidpointRounding.AwayFromZero);
            }
            ...
            {
                //Round the value so that the hash code will be the same with in the same precision range
                this.intercept = Math.Round(intercept, SCALE, MidpointRounding.AwayFromZero);
            }
