<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DMPrintSettings.aspx.cs"
    ValidateRequest="false" Inherits="GPS.Website.DMPrintSettings" %>
...
<body>
    ...
    <div id="print-settings" class="print-ui-layout-north">
        <div class="head-container ui-widget-header ui-corner-all">
            ...
            <div style="position: absolute; top: 9px; right: 6px;">
                <asp:LinkButton ID="lbtnPrint" runat="server" CssClass="gps-toolbar-button ui-corner-all"
                    PostBackUrl="~/Print/DMPrint.aspx" OnClientClick="javascript:OnPrintClickDM();"><span class="ui-icon ui-icon-print"></span>Print</asp:LinkButton>
        ...
        <div id="print-options-dialog" style="display: none;" title="Print Options">
            ...
            <div>
                <ul>
                    <%--<li>
                        <input id="cbxSuppressCoverPage" name="cbxSuppressLocations" type="checkbox" onclick="javascript:OnPrintOptionClickDM(this,'coverpage');" />Suppress
                        Cover Page </li>--%>
                    <li>
                   ...
                   <%-- <li>
                    ...
                    <%--<li>
                        <input id="cbxSuppressClassificationLevel" name="love" type="checkbox" onclick="javascript:OnPrintOptionClickDM(this,'classificationoutlines');" />Suppress
                        Classification Level Outlines </li>
                    <li>
                        <input id="cbxShowPenetrationColors" name="love" type="checkbox" onclick="javascript:OnPrintOptionClickDM(this,'penetrationcolor');" />Show
                        Distribution Map Penetration Colors </li>--%>
                    <%--<li>
    ...
    <div id="print-preview" class="print-outer-center">
        <div id="campaign-content" class="ui-widget-content ui-corner-all" style="position: relative;
            ...
            <%--<table id="cover-page" style="text-align: center;width:2300px" cellpadding="0" cellspacing="2" >
                <caption>
            ...
            <table id="campaign-submaps-summary" cellspacing="0" cellpadding="4" style="width:2300px">
                <%--<caption>
