<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reports.aspx.cs" Inherits="GPS.Website.Reports"  EnableEventValidation="false" %>
<%@ Register Src="~/WebControls/ReportWalker.ascx" TagName="ReportWalker" TagPrefix="Timm" %>
<%@ Register Src="~/WebControls/ReportDriver.ascx" TagName="ReportDriver" TagPrefix="Timm" %>
<%@ Register Src="~/WebControls/ReportAuditor.ascx" TagName="ReportAuditor" TagPrefix="Timm" %>
...
<body>
    ...
    <div class="head-container ui-widget-header ui-corner-all" style="width: 980px;">
        ...
        <%--<div id="divToolbar" style="position: absolute; top: 9px; right: 6px;" runat="server">--%>
    ...
    <div style="margin-left: auto; margin-right: auto; width: 980px;" id="tableDivs">
        <table>
            <tr><td><b>Campaign&nbsp;#:&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label id="camName" name="camName" runat="server"/></b></td></tr>
        ...
        <HeaderTemplate>
         <table cellspacing="0" cellpadding="0" border="0" id="test_table" name="driverDetailinfoTitle">
          ...
          <ItemTemplate>
               ...
               <Timm:ReportDriver ID="ReportDriver" runat="server"  CurrentUser='<%# (User)Container.DataItem%>'/>
        ...
        <HeaderTemplate>
         <table cellspacing="0" cellpadding="0" border="0" id="test_table" name="auditorDetailinfoTitle">
          ...
          <ItemTemplate>
               ...
               <Timm:ReportAuditor ID="ReportAuditor" runat="server"  CurrentUser='<%# (User)Container.DataItem%>'/>
