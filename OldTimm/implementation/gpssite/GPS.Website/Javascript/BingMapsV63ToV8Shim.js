...
var VEShape = (function () {
    ...
    VEShape.prototype.SetLineWidth = function (width) {
        if (this._shape instanceof Microsoft.Maps.Polyline || this._shape instanceof Microsoft.Maps.Polygon) {
            this._shape.setOptions({
...
var VEShapeLayer = (function () {
    function VEShapeLayer() {
        ...
        Microsoft.Maps.Events.addHandler(this._layer, 'mouseout', function (e) {
            if (_this._map) {
                _this._map._infobox.setOptions({
                    visible: false
                });
            }
        });
...
var VEMap = (function () {
    ...
    VEMap.prototype.GetShapeByID = VEMap.prototype.GetShapeById;
    ...
    VEMap.prototype.Find = function (what, where, findType, shapeLayer, startIndex, numberOfResults, showResults, createResults, useDefaultDisambiguation, setBestMapView, callback) {
        ...
        if (numberOfResults === void 0) {
            numberOfResults = 10;
        }
        if (showResults === void 0) {
            showResults = true;
        }
        if (setBestMapView === void 0) {
            setBestMapView = true;
        }
    ...
    VEMap.prototype.onMouseUpHack = function(e){
        VEMap.prototype._LastMouseEvent = e;
    }
    VEMap.prototype.onMouseDownHack = function(e){
        VEMap.prototype._LastMouseEvent = e;
    }
    document.removeEventListener('mouseup', VEMap.prototype.onMouseUpHack);
    document.addEventListener('mouseup', VEMap.prototype.onMouseUpHack);
    document.removeEventListener('mousedown', VEMap.prototype.onMouseDownHack);
    document.addEventListener('mousedown', VEMap.prototype.onMouseDownHack);

    VEMap.prototype._fillEventArg = function (arg, eventName, shape) {
        var _this = this;
        arg = arg || {};
        var x = (arg.pageX) ? arg.pageX : (arg.getX ? arg.getX() : 0);
        var y = (arg.pageY) ? arg.pageY : (arg.getY ? arg.getY() : 0);
        var e = {
            ...
            eventName: eventName,
            ctrlKey: _this._LastMouseEvent ? _this._LastMouseEvent.ctrlKey : false,
            altKey: _this._LastMouseEvent ? _this._LastMouseEvent.altKey : false
        };
    ...
    VEMap.prototype.GetImageryMetadata = function () {
        return null;
    };
    VEMap.prototype.GetPitch = function () {
        return 0;
    };
    VEMap.prototype.GetRoute = function () {
        return null;
    };
