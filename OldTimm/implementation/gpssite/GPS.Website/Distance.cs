...
namespace GPS.Website
{
    ...
    {
        private const double EARTH_RADIUS = 6378.137;//earth average radius, kilometre 
        ...
        public double CalcDist(double lat1, double lng1, double alt1, double lat2, double lng2, double alt2)
        {
