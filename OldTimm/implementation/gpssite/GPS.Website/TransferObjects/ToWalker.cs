...
namespace GPS.Website.TransferObjects
{
    ...
    public class ToWalker
    {
        ...
        /// </summary>
        /// <param name="target">A <see cref="ToWalker"/>, the DTO.</param>
        /// <param name="source">A <see cref="Walker"/>, the source.</param>
        public static void Convert(ref ToWalker target, ref WalkerAssignment source)
        {
