<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportAuditorTask.ascx.cs" Inherits="GPS.Website.WebControls.ReportAuditorTask" %>
...
--%>    <%--<tr>
    ...
    <tr>
     <td colspan="13" style="text-align:left;">
       <b><asp:Label ID="lblAuditorName" runat="server" Text=""></asp:Label></b>
     </td>
    </tr>
   <%-- <tr>
