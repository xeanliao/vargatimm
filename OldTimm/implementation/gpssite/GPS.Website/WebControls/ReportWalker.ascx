<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportWalker.ascx.cs" Inherits="GPS.Website.WebControls.ReportWalker" %>
...
--%>    <%--<tr>
    ...
    <tr>
     <td colspan="13" style="text-align:left;">
       <b><asp:Label ID="lblWalkerName" runat="server" Text=""></asp:Label></b>
     </td>
    </tr>
   <%-- <tr>
    ...
    <tr>
        <td style="width:10%">&nbsp;&nbsp;&nbsp;&nbsp;Avg.Speed(MPH):</td>
        <td style="width:7%"></td>
        <td style="width:7%"><asp:Label ID="avgSpeedN" runat="server" Text=""></asp:Label></td>
        <td style="width:7%"><asp:Label ID="highSpeedN" runat="server" Text=""></asp:Label></td>
        <td style="width:7%"><asp:Label ID="lowSpeedN" runat="server" Text=""></asp:Label></td>
        <td style="width:10%">Avg.Speed(MPH):</td>
        <td style="width:7%"><asp:Label ID="avgSpeedYTD" runat="server" Text=""></asp:Label></td>
        <td style="width:7%"><asp:Label ID="highSpeedYTD" runat="server" Text=""></asp:Label></td>
        <td style="width:7%"><asp:Label ID="lowSpeedYTD" runat="server" Text=""></asp:Label></td>
        <td style="width:10%">Avg.Speed(MPH):</td>
        <td style="width:7%"><asp:Label ID="avgSpeedLF" runat="server" Text=""></asp:Label></td>
        <td style="width:7%"><asp:Label ID="highSpeedLF" runat="server" Text=""></asp:Label></td>
        <td style="width:7%"><asp:Label ID="lowSpeedLF" runat="server" Text=""></asp:Label></td>
    </tr>
    <tr>
