<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CampaignPrint.aspx.cs"
    Inherits="GPS.Website.Print.CampaignPrint" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Campaign Print</title>
    <style>
        body
        {
...
<body>
    ...
    <div>
        <asp:Panel ID="plCoverPage" runat="server">
            <table id="firstpage" style="text-align: center;" cellpadding="0" cellspacing="2">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <asp:Image ID="imgVargaincLogo" ImageUrl="~/Images/vargainc-logo.png" Height="90px" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td style="height: 20px;">
            ...
            <tbody>
                <tr>
                    <td colspan="2" style="padding: 0px 1px 0px 1px;">
                        <asp:Image ID="imgCampaignMap" Width="100%" Style="margin-bottom: -2px;height:960px;" BorderStyle="None"
                            runat="server" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 90%; border-style: none; vertical-align: top;">
                        <asp:Repeater ID="rptColors" runat="server">
                            <HeaderTemplate>
                                COLOR LEGEND<br />
                                <table cellpadding="0" cellspacing="0" border="0" style="border-style: none; margin-top: 0px;">
                                    <tr>
                            </HeaderTemplate>
                            <ItemTemplate>
                    ...
                    <td style="width: 10%; text-align: right; border-style: none;">
                        <asp:Image ID="imgDirectionLegend" ImageUrl="~/Images/vargainc-logo.png" Height="90px" runat="server" />
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <asp:Repeater ID="rptSubMaps" runat="server" OnItemDataBound="rptSubMaps_ItemDataBound">
            <ItemTemplate>
                <div class="pagebreaker">
                </div>
                ...
                <table class="maptable" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="2" style="padding: 0px 1px 0px 1px;">
                                <img style="width: 100%;height:960px; margin-bottom: -2px;" src='<%# Eval("MapImgUrl") %>' />
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 90%; border-style: none; vertical-align: top;">
                            ...
                            <td style="width: 10%; text-align: right; border-style: none;">
                                <asp:Image ID="imgDirectionLegend2" ImageUrl="/Images/vargainc-logo.png" Height="90px" runat="server" />
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <asp:Literal ID="ltlFiveZips" runat="server"></asp:Literal>  
                ...
                <asp:Literal ID="ltlCRoutes" runat="server"></asp:Literal>                
               <%-- <asp:Repeater ID="rptCRoutes" runat="server">
                    <HeaderTemplate>
                        <table cellspacing="0" cellpadding="4">
                            <caption>
                                CARRIER ROUTES CONTAINED IN
                                <asp:Literal ID="ltlName" runat="server"></asp:Literal></caption>
                            <tbody>
                                <tr style="background-color: #eeeeee;">
                                    <td class="collabel" style="width: 10%">
                ...
                <asp:Literal ID="ltlTracts" runat="server"></asp:Literal>
                <%--<asp:Repeater ID="rptTracts" runat="server">
                    <HeaderTemplate>
                        <table cellspacing="0" cellpadding="4">
                            <caption>
                                CENSUS TRACTS CONTAINED IN
                                <asp:Literal ID="ltlName" runat="server"></asp:Literal></caption>
                            <tbody>
                                <tr style="background-color: #eeeeee;">
                                    <td class="collabel" style="width: 10%">
                ...
                <asp:Literal ID="ltlBlockGroups" runat="server"></asp:Literal>
