...
{
    public class PremiumCRoutesSatisfyingDistributionMapSpecification
    {
        #region Fields
        private readonly IEnumerable<Int32> _selectedFiveZipIds;
        private readonly IEnumerable<Int32> _deselectedFiveZipIds;
        ...
        public IEnumerable<Int32> DeselectedFiveZipIds { get { return _deselectedFiveZipIds; } }
        ...
        #region Constructors
        public PremiumCRoutesSatisfyingDistributionMapSpecification(
            IEnumerable<Int32> selectedFiveZipIds, IEnumerable<Int32> deselectedFiveZipIds,
            IEnumerable<Int32> selectedCRouteIds, IEnumerable<Int32> deselectedCRouteIds)
        {
            _selectedFiveZipIds = CorrectIds(selectedFiveZipIds);
            _deselectedFiveZipIds = CorrectIds(deselectedFiveZipIds);
        ...
        public IEnumerable<PremiumCRoute> GetSatisfyingAreas(IPremiumCRouteRepository repository)
        {
           return repository.GetPremiumCRoutesSatisfyingDistributionMap(this);
