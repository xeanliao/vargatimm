...
{
    public class TractsSatisfyingDistributionMapSpecification
    {
        #region Fields
        ...
        #region Constructors
        public TractsSatisfyingDistributionMapSpecification(
        ...
        {
            return repository.GetTractsSatisfyingDistributionMap(this);
        }
        #endregion
