...
{
    public class FiveZipsSatisfyingDistributionMapSpecification
    {
        #region Fields
        ...
        #region Constructors
        public FiveZipsSatisfyingDistributionMapSpecification(
        ...
        {
            return repository.GetFiveZipsSatisfyingDistributionMap(this);
        }
        #endregion
