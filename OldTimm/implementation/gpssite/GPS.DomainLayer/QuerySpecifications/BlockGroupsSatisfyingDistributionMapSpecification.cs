...
{
    public class BlockGroupsSatisfyingDistributionMapSpecification
    {
        #region Fields
        ...
        #region Constructors
        public BlockGroupsSatisfyingDistributionMapSpecification(
        ...
        {
            return repository.GetBlockGroupsSatisfyingDistributionMap(this);
        }
        #endregion
