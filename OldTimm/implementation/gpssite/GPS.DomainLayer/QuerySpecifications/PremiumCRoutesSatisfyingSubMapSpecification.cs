...
{
    public class PremiumCRoutesSatisfyingSubMapSpecification
    {
        #region Fields
        ...
        #region Constructors
        public PremiumCRoutesSatisfyingSubMapSpecification(
        ...
        {
            return repository.GetPremiumCRoutesSatisfyingSubMap(this);
        }
        #endregion
