...
namespace GPS.DomainLayer.Entities {
    ...
    public class ElementarySchoolArea : IBoxArea
    {
        ...
        public virtual IList<ElementarySchoolAreaBoxMapping> ElementarySchoolAreaBoxMappings
        {
            get;
            set;
        }

        public virtual IList<ElementarySchoolAreaCoordinate> ElementarySchoolAreaCoordinates
        {
            get;
            set;
        }
