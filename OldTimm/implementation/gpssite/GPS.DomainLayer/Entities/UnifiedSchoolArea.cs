...
{
    public class UnifiedSchoolArea : IBoxArea
    {
        ...
        public virtual IList<UnifiedSchoolAreaBoxMapping> UnifiedSchoolAreaBoxMappings { get; set; }

        public virtual IList<UnifiedSchoolAreaCoordinate> UnifiedSchoolAreaCoordinates { get; set; }
