...
namespace GPS.DomainLayer.Entities {
    ...
    public class LowerHouseArea : IBoxArea
    {
        ...
        public virtual IList<LowerHouseAreaBoxMapping> LowerHouseAreaBoxMappings { get; set; }

        public virtual IList<LowerHouseAreaCoordinate> LowerHouseAreaCoordinates { get; set; }
