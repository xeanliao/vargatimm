...
namespace GPS.FileLayer
{
    public class ODBCHelper
    {
        ...
        public static OdbcConnection CreateCSVConnection(string FolderPath)
        {
            ...
            FolderPath + ";Extensions=asc,csv,tab,txt;HDR=NO;Persist Security Info=False";
        ...
        /// <param name="FolderPath">the folder path</param>
        /// <returns>OdbcConnection</returns>
        public static OdbcConnection CreateCSVConnectionByJet(string FolderPath)
        {
            OdbcConnection oConn = new OdbcConnection();
            oConn.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" +
                FolderPath + ";Extended Properties='text;HDR=NO;FMT=Delimited'";
