...
namespace Gios.Pdf.SplitMerge
{
    ...
    public class PdfSplitterMerger : IDisposable
    {
        Stream target;
        long pos = 15;
        private int number = 3;
        private List<long> pageNumbers, xrefs;
        ...
        public PdfSplitterMerger(Stream OutputStream)
        {
            ...
            this.pageNumbers = new List<long>();
        ...
        private void Add(PdfSplitter PdfSplitter)
        {
            ...
            List<PdfFileObject> sortedObjects = new List<PdfFileObject>();
