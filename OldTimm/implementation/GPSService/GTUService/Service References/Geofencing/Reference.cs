...
namespace TIMM.GTUService.Geofencing {
    ...
    public interface IGeofencing {
        ...
        bool IsInTheArea(TIMM.GTUService.Geofencing.Coordinate oLocation, string sGUID);
        ...
        string IsInTheDNDArea(TIMM.GTUService.Geofencing.Coordinate oLocation, int[] ndAreaIds);
        ...
        string RegisterArea(TIMM.GTUService.Geofencing.Coordinate[] oArea);
        ...
        bool UpdateArea(string sGUID, TIMM.GTUService.Geofencing.Coordinate[] oArea);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface IGeofencingChannel : TIMM.GTUService.Geofencing.IGeofencing, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public partial class GeofencingClient : System.ServiceModel.ClientBase<TIMM.GTUService.Geofencing.IGeofencing>, TIMM.GTUService.Geofencing.IGeofencing {
        ...
        public bool IsInTheArea(TIMM.GTUService.Geofencing.Coordinate oLocation, string sGUID) {
            return base.Channel.IsInTheArea(oLocation, sGUID);
        }
        
        public string IsInTheDNDArea(TIMM.GTUService.Geofencing.Coordinate oLocation, int[] ndAreaIds) {
            return base.Channel.IsInTheDNDArea(oLocation, ndAreaIds);
        }
        
        public string RegisterArea(TIMM.GTUService.Geofencing.Coordinate[] oArea) {
            return base.Channel.RegisterArea(oArea);
        }
        
        public bool UpdateArea(string sGUID, TIMM.GTUService.Geofencing.Coordinate[] oArea) {
