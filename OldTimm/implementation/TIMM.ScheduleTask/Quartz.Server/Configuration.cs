...
namespace Quartz.Server
{
	...
	public class Configuration
	{
		...
		private const string DefaultServiceName = "TIMM.ScheduleTask";
        private const string DefaultServiceDisplayName = "TIMM.ScheduleTask";
        private const string DefaultServiceDescription = "TIMM Schedule Task Server base on Quartz.net";
