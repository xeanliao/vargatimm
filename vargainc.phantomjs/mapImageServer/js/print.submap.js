...
function loadMap(params) {
    console.log('begin ajax call', params);
    var query = [];

    var locationUrl = params.baseUrl + 'print/campaign/' + params.campaignId + '/submap/' + params.submapId + '/location';
    console.log(locationUrl);
    query.push($.getJSON(locationUrl));

    var recordUrl = params.baseUrl + 'print/campaign/' + params.campaignId + '/submap/' + params.submapId + '/record';
    console.log(recordUrl);
    query.push($.getJSON(recordUrl));

    var addressUrl = params.baseUrl + 'print/campaign/' + params.campaignId + '/address';
    console.log(addressUrl);
    query.push($.getJSON(addressUrl));

    if (!params.suppressNDAInSubMap) {
    ...
    $.when.apply(this, query).done(function () {
        ...
        callback('ajax call failed : ' + submapUrl);
    });
}
